...
val BackgroundGradientStyle by ComponentStyle.base {
    Modifier
        .background(
            CSSBackground(
                image = BackgroundImage.of(linearGradient(90.deg, Color.rgb(34, 222, 237), Color.rgb(135, 89, 215)))
            ),
            CSSBackground(
                image = BackgroundImage.of(
                    radialGradient(RadialGradient.Shape.Circle, CSSPosition(75.percent, 99.percent)) {
            ...
            CSSBackground(
                image = BackgroundImage.of(
                    radialGradient(RadialGradient.Shape.Circle, CSSPosition(15.percent, 16.percent)) {
            ...
            CSSBackground(
                image = BackgroundImage.of(
                    radialGradient(RadialGradient.Shape.Circle, CSSPosition(86.percent, 7.percent)) {
            ...
            CSSBackground(
                image = BackgroundImage.of(
                    radialGradient(RadialGradient.Shape.Circle, CSSPosition(66.percent, 97.percent)) {
            ...
            CSSBackground(
                image = BackgroundImage.of(
                    radialGradient(RadialGradient.Shape.Circle, CSSPosition(40.percent, 91.percent)) {
